...
@WebServlet("/deleteGardening")
public class DeleteControllerGardening extends HttpServlet{
	private static final long serialVersionUID = -8195123807449469536L;
	private static final Logger logger = LoggerFactory.getLogger(DeleteControllerGardening.class.getName());
